...
public class GetClearanceRequestsIntervalsTests(ApiWebApplicationFactory factory, ITestOutputHelper outputHelper)
    : EndpointTestBase(factory, outputHelper)
{
    ...
    public async Task Get_WhenUnauthorized_ShouldBeUnauthorized()
    {
        ...
        var response = await client.GetAsync(Testing.Endpoints.ClearanceRequests.Intervals());
