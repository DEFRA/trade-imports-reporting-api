...
aws --endpoint-url="$AWS_ENDPOINT_URL" sqs set-queue-attributes --queue-url "$AWS_ENDPOINT_URL/000000000000/trade_imports_tracescheds_upserted_reporting_api" --attributes '{"RedrivePolicy": "{\"deadLetterTargetArn\":\"arn:aws:sqs:eu-west-2:000000000000:trade_imports_tracescheds_upserted_reporting_api-deadletter\",\"maxReceiveCount\":\"1\"}"}'
